...
static const Fvector	ps_r__Tree_Wave		= { 0.1f,0.01f,0.11f };
static const float		ps_r__Tree_w_rot	= 10.0f;
static const float		ps_r__Tree_w_speed	= 1.00f;
static const float		ps_r__Tree_w_amp	= 0.005f;
...
void FTreeVisual::Render	(float LOD)
{
	...
	float	s				= 1.5f; // 1.5f scalable bias correct
