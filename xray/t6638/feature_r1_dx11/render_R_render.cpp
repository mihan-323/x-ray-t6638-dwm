...
{
	PIX_EVENT(CRender_RenderDeffered);
...

	{
		...
		if(o.aa_mode == AA_MSAA)	RCache.set_Stencil(TRUE, D3D_COMPARISON_ALWAYS, 0x01, 0xff, 0x7f, D3D_STENCIL_OP_KEEP, D3D_STENCIL_OP_REPLACE, D3D_STENCIL_OP_KEEP);
		else						RCache.set_Stencil(TRUE, D3D_COMPARISON_ALWAYS, 0x01, 0xff, 0xff, D3D_STENCIL_OP_KEEP, D3D_STENCIL_OP_REPLACE, D3D_STENCIL_OP_KEEP);
