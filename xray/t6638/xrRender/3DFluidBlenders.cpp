...
void SetupSamplers(CBlender_Compile& C)
{
	...
	if ( smp != u32(-1) )
	{
		C.i_dx10Address( smp, D3D_TEXTURE_ADDRESS_CLAMP);
	...
	if ( smp != u32(-1) )
	{
		C.i_dx10Address( smp, D3D_TEXTURE_ADDRESS_WRAP);
		C.i_dx10Filter( smp, D3DTEXF_LINEAR, D3DTEXF_LINEAR, D3DTEXF_LINEAR);
	}
...
void SetupTextures(CBlender_Compile& C)
{
	...
	//	Renderer
	C.r_dx10Texture("sceneDepthTex", tex_rt_Position);
...
void CBlender_fluid_simulate::Compile(CBlender_Compile& C)
{
	...
	case 1:			// Confinement
		...
		C.r_Pass	("fluid_grid", "fluid_array", "fluid_confinement", false,FALSE,FALSE,TRUE, D3D_BLEND_ONE, D3D_BLEND_ONE);
		break;
	case 2:			// Divergence
...
void CBlender_fluid_emitter::Compile(CBlender_Compile& C)
{
	...
	case 0:			// ET_SimpleGausian
		C.r_Pass	("fluid_grid", "fluid_array", "fluid_gaussian", false,FALSE,FALSE,TRUE, D3D_BLEND_SRC_ALPHA, D3D_BLEND_INV_SRC_ALPHA);
...
void CBlender_fluid_raydata::Compile(CBlender_Compile& C)
{
	...
	case 1:			// CompRayData_Front
		C.r_Pass	("fluid_raydata_front", "null", "fluid_raydata_front", false,FALSE,FALSE,TRUE, D3D_BLEND_ONE, D3D_BLEND_ONE);
		...
		C.RS.SetRS(D3DRS_BLENDOP, D3D_BLEND_OP_REV_SUBTRACT); // DST - SRC
		C.RS.SetRS(D3DRS_BLENDOPALPHA, D3D_BLEND_OP_REV_SUBTRACT); // DST - SRC
...
void CBlender_fluid_raycast::Compile(CBlender_Compile& C)
{
	...
	case 2:			// QuadRaycastCopyFog
		C.r_Pass	("fluid_raycast_quad", "null", "fluid_raycastcopy_quad", false,FALSE,FALSE,TRUE, D3D_BLEND_SRC_ALPHA, D3D_BLEND_INV_SRC_ALPHA);
	...
	case 4:			// QuadRaycastCopyFire
		C.r_Pass	("fluid_raycast_quad", "null", "fluid_raycastcopy_quad_fire", false,FALSE,FALSE,TRUE, D3D_BLEND_SRC_ALPHA, D3D_BLEND_INV_SRC_ALPHA);
		C.r_ColorWriteEnable(true, true, true, false);
		C.r_CullMode(D3D_CULL_BACK);	//	Back
		break;
	}
